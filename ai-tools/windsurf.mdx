...
Configure Windsurf's Cascade AI assistant to help you write and maintain documentation. This guide shows how to set up Windsurf specifically for Falconyte documentation workflows.
...
- This is a documentation project for the Falconyte platform
